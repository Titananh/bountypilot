...
bounty skill run bug-bounty-pilot https://example.com --program example-program --mode passive --dry-run
bounty hunt recon https://example.com --profile passive --dry-run
