...
| Release | `bounty release public-gate OWNER/REPO --online --actions --write-public-plan .bounty/release/public-readiness.md --json` | GitHub git remote and GitHub CLI when requested | Runs the final public gate by combining publish status, skill score, public-readiness plan output, and install verification commands. |
